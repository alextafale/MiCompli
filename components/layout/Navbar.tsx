...
export default function Navbar() {
  ...
  const isTarjetaDigital = pathname === '/explorar' && searchParams.get('categoria') === 'tarjeta_digital'
      ...
      >
        ...
        <div className="flex items-center gap-3 md:gap-6">
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <Link href="/explorar?categoria=tarjeta_digital" className={navLink}>
              Tarjeta Digital
              <span className={underline} />
            </Link>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <Link href="/explorar?categoria=tarjeta_digital" onClick={closeMenu} className="text-xl font-display font-bold uppercase tracking-[2px] text-ink hover:text-rose transition-colors">
              Tarjeta Digital
            </Link>
